...
const ModalEdit = ({student}) =>{
  ...
  useEffect(()=>{
   ...
   return(
         <div className="modal fade" id={`exampleModal${students.id}`} tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-md-6 ">
                  ...
                  aria-label="First name" value={students.name}
                ...
                <div className="col-md-6 ">
                  ...
                  aria-label="Last name" value={students.phone}
                  onChange={e =>setStudents({
                    ...students,
                ...
                <div className="col-md-6 mt-4">
                  ...
                  aria-label="First name" value={students.email}
                  onChange={e =>setStudents({
                    ...students,
